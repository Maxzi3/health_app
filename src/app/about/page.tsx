        ...
        <section className="relative py-20 bg-gradient-to-br from-primary/5 via-background to-background">
          <div className="container mx-auto px-4 text-center max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              ...
              personalized, and secure — for everyone, everywhere.
            </p>
          ...
          <div className="container mx-auto px-4 max-w-5xl grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                ...
                access, secure, and available 24/7. We leverage AI-powered
                triage and secure telemedicine tools to bridge the gap between
                patients and healthcare professionals — all at the tap of a
                button.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Our team is passionate about creating technology that saves
                lives and gives peace of mind to families, healthcare providers,
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-3">
              ...
              <Card className="shadow-soft hover:shadow-medium transition-shadow">
                <CardContent className="p-8 text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    From AI-powered triage to instant video consultations, we
                    push the boundaries of what digital healthcare can do.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 max-w-5xl text-center space-y-6">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Today, Medify is trusted by patients and providers across multiple
              countries, providing accessible healthcare solutions to urban
