      ...
      <CardContent className="p-5 space-y-4">
        ...
        <div className="text-sm ">
          ...
          <textarea
            ...
            className="w-full mt-1 pl-6 border border-gray-300 rounded-md p-2 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-muted"
          />
        </div>
